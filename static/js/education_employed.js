...
d3.csv("/static/data/education_employed.csv", function (err, myData) {
  console.log("/static/data/education_employed.csv")

  if (err) throw err;

  myData.forEach(function (data) {
    data.snum = Number(data.snum);
    data.bachelor_employed = Number(data.bachelor_employed);
    data.master_employed = Number(data.master_employed);
    data.doctor_employed = Number(data.doctor_employed);
  });
  ...
  var currentAxisLabelX = "snum";

  var currentAxisLabelY = "bachelor_employed";
  ...
  chart
    ...
    .attr("data-axis-name-Y", "employed")
    .text("Employed");
  ...
  chart
    ...
    .attr("data-axis-name-X", "bachelor_employed")
  ...
  chart
    ...
    .attr("data-axis-name-X", "master_employed")
  ...
  chart
    ...
    .attr("class", "axis-text-X inactive")
    .attr("data-axis-name-X", "doctor_employed")
  ...
  d3.selectAll(".axis-text-X").on("click", function () {
    ...
    // Y-axis here
    currentAxisLabelY = clickedSelection_X.attr("data-axis-name-X");
    // Call findMinAndMax() to define the min and max domain values.
    findMinAndMax_Y(currentAxisLabelY);
