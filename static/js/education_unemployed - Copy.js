...
d3.csv("assets/data/education_unemployed.csv", function (err, myData) {
  ...
  myData.forEach(function (data) {
    ...
    data.bachelor_unemployed = Number(data.bachelor_unemployed);
    data.master_unemployed = Number(data.master_unemployed);
    data.doctor_unemployed = Number(data.doctor_unemployed);
  });
  ...
  var currentAxisLabelY = "bachelor_unemployed";
  ...
  chart
    ...
    .attr("data-axis-name-Y", "unemployed")
    .text("Unemployed");
  ...
  chart
    ...
    .attr("data-axis-name-X", "bachelor_unemployed")
  ...
  chart
    ...
    .attr("data-axis-name-X", "master_unemployed")
  ...
  chart
    ...
    .attr("class", "axis-text-X inactive")
    .attr("data-axis-name-X", "doctor_unemployed")
