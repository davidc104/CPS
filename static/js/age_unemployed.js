...
d3.csv("/static/data/age_unemployed.csv", function (err, myData) {
    console.log("/static/data/age_unemployed.csv")

    if (err) throw err;

    myData.forEach(function (data) {
        data.mo_age = Number(data.mo_age);
        data.mo_unemployed = Number(data.mo_unemployed);
        data.ks_age = Number(data.ks_age);
        data.ks_unemployed = Number(data.ks_unemployed);
    });
    ...
    var currentAxisLabelY = "mo_unemployed";
    ...
    chart
        ...
        .text("Unemployed ages in Missouri");
    ...
    chart
        ...
        .text("Unemployed ages in Kansas");
    ...
    d3.selectAll(".axis-text-X").on("click", function () {
        ...
        console.log(currentAxisLabelX);
        if (currentAxisLabelX == "mo_age") {
            currentAxisLabelY = "mo_unemployed";
            state_abbr = "MO";
        }
        else {
            currentAxisLabelY = "ks_unemployed";
            state_abbr = "KS";
        }
...
function writeAnalysis(yAxis) {
    ...
    var responses = "The top five age groups in Missouri with the highest employment: " +
        "18, 24, 51, 56, and 61 respectively.<br>" +
        "The top five age groups in Kansas with the highest employment: " +
        "18, 23, 29, 40, and 16 respectively.<br>" +

        "<br>Future studies:<br>" +
        "1. Do the rates of discrimination vary by state?<br>";
